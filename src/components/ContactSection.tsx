...
const ContactSection = () => {
  ...
  return (
    <section className="py-20 lg:py-28 bg-secondary" id="contact-us">
      <div className="section-container grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-20">
        ...
        {/* Right - Form */}
        <div className="bg-foreground/20 rounded p-8 lg:p-10">
          <div className="mb-7">
          ...
          <div className="mb-4">
            <label className="block text-[11px] font-semibold tracking-[0.14em] uppercase text-secondary-foreground/50 mb-2">Company / Brand</label>
            <input type="text" placeholder="Your company name" className="w-full bg-secondary-foreground/6 border border-primary/20 rounded-sm px-4 py-3 text-sm text-secondary-foreground placeholder:text-secondary-foreground/30 outline-none focus:border-primary transition-colors" />
          </div>
          ...
          <div className="mb-6">
            ...
            <textarea placeholder="Tell us more about your interest..." className="w-full bg-secondary-foreground/6 border border-primary/20 rounded-sm px-4 py-3 text-sm text-secondary-foreground placeholder:text-secondary-foreground/30 outline-none focus:border-primary transition-colors min-h-[100px] resize-y" />
          </div>

          <button
            onClick={() => setSubmitted(true)}
            className={`w-full font-condensed text-sm font-bold tracking-[0.14em] uppercase py-3.5 rounded-sm transition-all ${
              submitted
                ? "bg-forest-light text-secondary-foreground"
